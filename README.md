...
Closure is the way we tell what variables we have access to and is the idea that the child function can reach into its parent function and pull down from it.
