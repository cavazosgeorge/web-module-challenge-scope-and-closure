...
/*Task 1: counterMaker()
  ...
  Counter1 is counting from 0 zero every time it is called and updating however counter 2 is also counting from 0 but it is NOT updating
 
  2. Which of the two uses a closure? How can you tell?

  Counter1 Is using closure because it has a parent function to pull from whereas counter 2 does NOT pull from a parent function
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  

     Counter1 would be preferable when needing to count score in a sporting game, since it continues to update the score every time the function is called.
